<template>
  <div id="about" class="w-full px-12 pt-10 pb-36">
		...
		<div class="mt-24 flex justify-center items-center relative">
			...
			<div class="w-[720px] h-[350px] bg-primary left-[380px] border-[6px] z-20 border-primary-dark rounded-lg absolute">
				...
				<router-link to="/about" class="w-[170px] h-[52px] rounded-[6px] overflow-hidden border border-black flex items-center absolute bottom-6 right-[72px] z-30 hover:bottom-7 transition-all duration-300 ease-in group">
				...
				<button class="w-[170px] h-[52px] rounded-[6px] bg-black opacity-60 absolute bottom-5 right-[68px] z-20"></button>
			</div>
